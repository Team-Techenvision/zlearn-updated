...
// Route::post('forget-password', 'ForgotPasswordController@showForgetPasswordForm')->name('forget.password.post'); 

// Route::get('reset-password/{token}', 'ForgotPasswordController@showForgetPasswordForm')->name('reset.password.get');

// Route::post('reset-password', 'ForgotPasswordController@showForgetPasswordForm')->name('reset.password.post');
...
Route::middleware(['auth', 'Admin'])->group(function () {
    ...
    Route::get('view-college-admin', 'AdminController@view_college_admin');
    Route::get('add-college-admin', 'AdminController@add_college_admin');
    Route::post('submit-college-admin', 'AdminController@submit_college_admin');
    Route::get('edit-college-admin/{id}', 'AdminController@edit_college_admin');
    Route::get('delete-college-admin/{id}', 'AdminController@delete_college_admin');
